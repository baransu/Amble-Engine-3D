...
public:
    ...
    void setupUi(QMainWindow *EditorClass)
    {
        ...
        widget->setBaseSize(QSize(1280, 720));
        QPalette palette;
        ...
        QBrush brush3(QColor(255, 63, 159, 255));
        brush3.setStyle(Qt::SolidPattern);
        palette.setBrush(QPalette::Active, QPalette::Midlight, brush3);
        QBrush brush4(QColor(127, 0, 63, 255));
        brush4.setStyle(Qt::SolidPattern);
        palette.setBrush(QPalette::Active, QPalette::Dark, brush4);
        QBrush brush5(QColor(170, 0, 84, 255));
        ...
        QObject::connect(pushButton, SIGNAL(clicked()), EditorClass, SLOT(close()));
    ...
    void retranslateUi(QMainWindow *EditorClass)
    {
        ...
        pushButton->setText(QApplication::translate("EditorClass", "&Quit", 0));
    } // retranslateUi
